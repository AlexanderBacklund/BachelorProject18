...
Webapplikationen erbjuder även en admin sida. Här kan man se alla användare, man kan ge behörigheter till olika användare. Om man är admin på webapplikationen kan man tex ge andra använda behörighet till att se adminsidan alternativt ändra i adminsidan.  
