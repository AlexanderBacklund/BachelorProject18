...
\section{Vår produkt}
I följande delavsnitt beskrivs implementationen av de olika komponenterna av vårat system i mer detalj. Först beskrivs hur applikationen används för att skapa referenspunkter. Sedan beskrivs det hur en position beräknas utifrån dessa punkter. Till sist beskrivs systemets presentations applikation.
...
\subsubsection{Hämta information om referenspunkter från databasen}
...
Algoritmen för metod 1, med syfte att uppskatta vilken referenspunkt som befinner sig närmast klientenheten ser ut som följer:
  ...
  \begin{figure}[H]
    \centering
  	...
  	\caption{Poängsystem för åtkommstpunkt 1}
  	\label{fig:MAC1}
  \end{figure}
  \begin{figure}[H]
    \centering
  	\includegraphics[width=10cm]{media/MAC_2.png}
  	\caption{Poängsystem för åtkommstpunkt 2}
  	\label{fig:MAC2}
  \end{figure}
  \begin{figure}[H]
    \centering
  	\includegraphics[width=10cm]{media/MAC_3.png}
  	\caption{Poängsystem för åtkommstpunkt 3}
  	\label{fig:MAC3}
  \end{figure}
