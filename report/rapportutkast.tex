...
SFB erbjuder två olika versioner av tjänsten. Den ena varianten, SFB \textit{Online} är en molnbaserad tjänst som inte kräver några fysiska servrar hos användaren \cite{SFBonline}.
...
Följande sektion består av resultat från de tester beskrivna i sektion (\ref{sec:krav}). I våningstestet fick systemet 100\% träffsäkerhet, det vill säga att vart användaren än var på en våning så visade systemet varenda gång att användaren var på samma våning. %TODO inforga bild och fortsätt att snacka om detta
