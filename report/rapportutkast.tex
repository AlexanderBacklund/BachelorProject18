...
Webbapplikationen utgörs initialt av en inloggningssida se figur \ref{fig:comp_log_in}, där arbetaren på arbetsplatsen måste logga in för att se positioner för andra medarbetare. När arbetaren har loggat in så har arbetaren möjlighet att se dess medarbetares position, söka efter specifika medarbetare och göra valet att dölja sin position, se figur \ref{fig:comp_show_position}.

\begin{figure}[H]
  \centering
  \includegraphics[width=14cm, height=12cm]{media/comp_log_in.png}
