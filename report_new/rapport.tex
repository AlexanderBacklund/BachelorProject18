...
Eftersom skriptet för klientenheterna är skrivet i Python (se sektion \ref{pythonskript}) använder vi ett interface för Python som heter PyMySQL\cite{pymysql}. PyMySQL erbjuder ett API som ger möjligheten att direkt i pythonkoden skriva funktioner som kan hantera tabeller i databasen.
 ...
 \iffalse Eftersom databasen är MySQL-baserad används ett interface för Python som heter PyMySQL\cite{mysqldb}%TODO byt referens
 ...
 I den här implementationen av systemet har vi valt att använda en databas på Uppsala Universitets nätverk. Valet av att använda en databas på Uppsala Universitets nätverk motiveras av att det vid en implementation av systemet på en arbetsplats är tänkt att databasen ska placeras på företagets interna nätverk. Då vi inte har haft tillgång till vår intressents interna nätverk valde vi således använda en databas som vi har tillgång till genom tidigare studier på Uppsala Universitet.   
